...
function Rating() {
  ...
  return (
    <div style={{ maxWidth: "500px", margin: "0 auto", color: "black" }}>
      <h2 style={{ color: "#00FF00", textShadow: "0 0 5px #00FF00, 0 0 10px #00FF00" }}>Formulir Komentar</h2>

      <form onSubmit={handleSubmit}>
        <div style={{ marginBottom: "1em" }}>
          <label htmlFor="name" style={{ color: "#00FF00", fontWeight: "bold" }}>Nama:</label>
          <input
            type="text"
            id="name"
            value={name}
            ...
            required
            style={{ width: "100%", padding: "8px", color: "#00FF00", backgroundColor: "black", border: "1px solid #00FF00" }}
          />
        </div>

        <div style={{ marginBottom: "1em" }}>
          <label htmlFor="comment" style={{ color: "#00FF00", fontWeight: "bold" }}>Komentar:</label>
          <textarea
            id="comment"
            value={comment}
        ...
        <button type="submit" style={{ padding: "10px 15px", backgroundColor: "#4CAF50", color: "#fff" }}>
          Kirim Komentar
        </button>
      </form>
      ...
      <div style={{ marginTop: "2em" }}>
        ...
        <div style={{ width: "100%", backgroundColor: "#ddd", borderRadius: "5px", height: "20px" }}>
          {/* Perbaiki syntax untuk template literal */}
          <div style={{ width: `${ratingPercentage}%`, backgroundColor: "green", height: "100%", borderRadius: "5px" }} />
        </div>
      ...
      <div style={{ marginTop: "2em" }}>
        ...
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          <thead>
            <tr>
              <th style={{ border: "1px solid #ddd", padding: "8px", color: "#00FF00" }}>Nama</th>
              <th style={{ border: "1px solid #ddd", padding: "8px", color: "#00FF00" }}>Komentar</th>
          ...
          <tbody>
            {feedbacks.map((feedback, index) => (
              <tr key={index}>
                <td style={{ border: "1px solid #ddd", padding: "8px", color: "#00FF00" }}>{feedback.name}</td>
                <td style={{ border: "1px solid #ddd", padding: "8px", color: "#00FF00" }}>{feedback.comment}</td>
